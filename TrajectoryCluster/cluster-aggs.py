...
#     kmeans_model = AgglomerativeClustering(n_clusters=k, affinity='precomputed',linkage='average')
...
dbscan = AgglomerativeClustering(n_clusters=n_clusters, affinity='precomputed', linkage='average')
...
colors_dict = {-1: 'red', 0: 'green', 1: 'blue', 2: 'cyan', 3: 'purple', 4: 'magenta', 5: 'darksalmon', 6: 'gray',
               7: 'r', 8: 'pink', 9: 'yellow', 10: 'coral', 11: 'azure', 12: 'beige', 13: 'bisque', 14: 'brown',
               15: 'crimson'}
fig = plt.figure()
a1 = fig.add_subplot(111)
colorLegend = []
